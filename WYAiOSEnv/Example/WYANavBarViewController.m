...
- (UIButton *)tempRightButton1 {
    if (!_tempRightButton1) {
        _tempRightButton1 = ({
            ...
            [object setTitleColor:[UIColor wya_grayTitleColor] forState:UIControlStateHighlighted];
...
- (UIButton *)tempLeftButton1 {
    if (!_tempLeftButton1) {
        _tempLeftButton1 = ({
            ...
            [object setTitleColor:[UIColor wya_blackTitleColor] forState:UIControlStateNormal];
            [object setTitleColor:[UIColor wya_grayTitleColor] forState:UIControlStateHighlighted];
            object.titleLabel.font = FONT(16);
            [object addTarget:self
...
- (UITableViewCell *)tableView:(UITableView *)tableView
    ...
    cell.backgroundColor = [UIColor wya_bgColor];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (index) {
        case 0: {
            // 设置背景色
            self.navBackGroundColor      = [UIColor wya_blueColor];
        ...
        case 5: {
            ...
            [self wya_addRightNavBarButtonWithNormalTitle:@[ @"帮助", @"更多" ]
                                              normalColor:@[ [UIColor wya_blueColor], [UIColor wya_blueColor] ]
                                         highlightedColor:@[]];
        } break;
        case 6: {
            // 设置左侧文字+图片
